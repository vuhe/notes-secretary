...
const buttonVariants = cva(
  "focus-visible:border-ring focus-visible:ring-ring/50 aria-invalid:ring-destructive/20 " +
    ...
    "rounded-md border border-transparent bg-clip-padding text-sm font-medium focus-visible:ring-[3px] " +
    "aria-invalid:ring-[3px] [&_svg:not([class*='size-'])]:size-4 inline-flex items-center justify-center " +
    ...
    "[&_svg]:pointer-events-none shrink-0 [&_svg]:shrink-0 outline-none group/button select-none",
  {
    variants: {
      variant: {
        ...
        outline:
          "border-border bg-background hover:bg-muted hover:text-foreground dark:bg-input/30 " +
          "dark:border-input dark:hover:bg-input/50 aria-expanded:bg-muted aria-expanded:text-foreground shadow-xs",
        secondary:
        ...
        destructive:
          ...
          "dark:focus-visible:ring-destructive/40 dark:bg-destructive/20 text-destructive " +
